...
class WebQSPFinetuneSentences(GeneratorBasedBuilder):
    VERSION = "1.0.1"
    BUILDER_CONFIGS = [
        BuilderConfig(
            name="WebQSPFinetuneSentences",
            version=VERSION,
            description=("")
        )
    ]
    ...
    def _split_generators(self, dl_manager: Any) -> List[SplitGenerator]:
        ...
        web_qsp_path = script_dir.parent.parent / 'data' / 'artifacts' / 'WebQSPFinetuneSentences_v1' / 'publish' / 'WebQSPFinetuneSentences_v1.tar'
        urls = {
